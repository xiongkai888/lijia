...
public class HorizontalStepView extends LinearLayout implements HorizontalStepsViewIndicator.OnDrawIndicatorListener {
    ...
    private int mUnComplectedTextColor = ContextCompat.getColor(getContext(), R.color.color666);//定义默认未完成文字的颜色;
    private int mComplectedTextColor = ContextCompat.getColor(getContext(), R.color.color33cea6);//定义默认完成文字的颜色;
    ...
    public void setPosition(int position){
        ...
        mStepsViewIndicator.setPosition(position);
    }
