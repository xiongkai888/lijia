...
import com.lanmei.lijia.tts.control.InitConfig;
import com.lanmei.lijia.tts.listener.UiMessageListener;
import com.lanmei.lijia.tts.util.AutoCheck;
...
/**
 * Created by xkai on 2018/5/17.
 */

public class TTSHelper {

    private String TAG = "SpeechSynthesizer";
     ...
     */
    protected String appId = "11178514";

    protected String appKey = "X25sOZjKpZRdYy9a21rI6T1yeLIvXrjL";

    protected String secretKey = "Z1sLVu0byENw81Eof4udHBemvbn6SY0y";
     ...
     */
    public boolean initTTSPermission() {
        String[] permissions = {
        ...
        if (!toApplyList.isEmpty()) {
            ActivityCompat.requestPermissions((BaseActivity) context, toApplyList.toArray(tmpList), 123);
            return true;
        }
        return false;
    }
    ...
    private void initTTs() {
        LoggerProxy.printable(L.debug); // 日志打印在logcat中
...
//                print("离线资源存在并且可读, 目录：" + TEMP_DIR);
    ...
    private void checkResult(int result, String method) {
        if (result != 0) {
            ...
            print("result code :" + result + " method:" + method);
        }
    }

    private void print(String message) {
        L.d(TAG, "百度语音：" + message);
    }
