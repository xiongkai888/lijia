...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context, int count) {
        ...
        } else if (manufacturer.toLowerCase().contains("samsung") || manufacturer.toLowerCase().contains("lg")) {
        ...
        } else if (manufacturer.toLowerCase().contains("HUAWEI") || Build.BRAND.equals("Huawei") || Build.BRAND.equals("HONOR")) {//华为
            setHuaweiBadge(context, count-1);
        } else if (manufacturer.toLowerCase().contains("OPPO")) {//oppo
            setBadgeOfOPPO(context, count);
        } else if (manufacturer.toLowerCase().contains("")) {//魅族
    ...
    public static void sendToXiaoMi(Context context, int count) {
        L.d(LiJiaReceiver.LogTag,"小米手机信息个数："+count);
        try {
            ...
            L.d(LiJiaReceiver.LogTag,"小米手机信息：try");
        } catch (Exception e) {
            e.printStackTrace();
            L.d(LiJiaReceiver.LogTag,"小米手机信息：catch");
            // miui 6之前的版本
