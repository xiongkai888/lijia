package com.lanmei.lijia.view.stepview;
...
//    public static int mComplectingPosition;//正在进行position   underway position
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mCircleCenterPointPositionList.size() - 1; i++) {
            ...
            if (i <= position-1) {//判断在完成之前的所有点
                //判断在完成之前的所有点，画完成的线，这里是矩形,很细的矩形，类似线，为了做区分，好看些
                L.d("BaseAppCompatActivity", "canvas.drawRect(preComplectedXPosition + mCircleRadius - 10, mLeftY, afterComplectedXPosition - mCircleRadius + 10, mRightY, mCompletedPaint);");
                ...
                L.d("BaseAppCompatActivity", "mPath.moveTo(preComplectedXPosition + mCircleRadius, mCenterY);");
            }
        }
        //-----------------------画线-------draw line-----------------------------------------------
...
//                    L.d("BaseAppCompatActivity", "mComplectingPosition  :" + mComplectingPosition);
//                }
//            }
//        }
